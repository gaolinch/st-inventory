//
//  OutScanProductController.swift
//  st-inventory
//
...
class OutScanProductController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
...
//        let test2 = "22"
//
//        skus.setValue(true, forKey: test)
//        skus.setValue(true, forKey: test2)
//        skus.setValue(true, forKey: test)
//
//
//        print(skus as Any)
//
//        let stringCodeValue = "21"
//        codeLabel.text = stringCodeValue
//         //displayOutSelectReasonController(scannedCode: skus)
//}
...
//    }()
    ...
    func displayOutSelectReasonController(scannedCode: NSMutableDictionary) {
        let outSelectReasonController = OutSelectReasonController()
        outSelectReasonController.scannedCode = scannedCode
        navigationController?.pushViewController(outSelectReasonController, animated: true)
        //present(outSelectReasonController, animated: true, completion: nil)
    }
